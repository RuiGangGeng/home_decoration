...
class Api
{
    ...
    protected function _initialize()
    {
        ...
        $list_rows = $this->request->get('list_rows',10);
        $this->paginate = ['page' => $page, 'list_rows' => $list_rows];
    }
     ...
     * @param bool $double 是否多条数据
     * @return string
     */
    protected static function patch_oss($url,$double = false)
    {
        if($double){
            $arr = explode(',',$url);
